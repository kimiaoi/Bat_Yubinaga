...
cfg = {
    'A': [16,16, 'M', 32,32, 'M', 64, 64, 'M', 256, 256,256, 'M'],
}
...
#create model
vgg_var = vgg11_bn()
vgg_var.load_state_dict(torch.load("./logsVGGCustom/saveVGGCustom.pth"))
vgg_var.cuda()
...
for e in range(100) :
    ...
    # save weight
    torch.save(vgg_var.state_dict(), "./logsVGGCustom/pytorch{0}.pth".format(e))
