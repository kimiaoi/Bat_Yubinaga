...
#create to list file with trainning and testing data name (use it the first time you lunch the script)
# create_two_list("./data")

#create generator
train_gen = data_generator("./newtrainlist.npy")
...
for e in range(100) :
    ...
    for d in train_gen:
        ...
        if i > 2395:
            break
    # print("Mean loss of epoch {0} : {1}".format(e,np.array(all_loss_epoch).mean()))
    # save weight
    torch.save(vgg_var.state_dict(), "./logsVGG16/pytorch{0}.pth".format(e))
